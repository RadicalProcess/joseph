...
namespace rp::joseph::Constants
{
    ...
    const std::array<std::pair<float, std::string>, 3> labelFreqs = {{{100.f, "100"}, {1000.f, "1K"}, {10000.0f, "10K"}}};
    const std::array<std::pair<float, std::string>, 3> labelDecibels = {{{-100.0f, "-100"}, {-50.0f, "-50"},  {0.0f, "0"}}};
